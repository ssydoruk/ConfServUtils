...
try {
  ...
  var srcDNs = findObjectByName("CfgDN", "VQ_Voice_CX_CommEd_English_NA");
  //   var srcDNs = findObjectByName("CfgDN", "33184884000");

  if (srcDNs != null) {
    var switches = objectDBID_props("CfgSwitch");
    var csv = CS.readCSV("/Users/stepan_sydoruk/Documents/CMEImport/TRIPEXP-36/VQs.csv"); // returned is ArrayList of String Array
