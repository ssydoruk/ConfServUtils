 ...
 */
abstract class CSVImportLoginIDs extends CSVGeneralImportDialog {

    static CSVImportLoginIDs instance = null;

    public static CSVImportLoginIDs getInstance(Window parent, ConfigServerManager cfg) {
        if (instance == null) {
            instance = new CSVImportLoginIDs(parent, cfg) {
            };
        }
        return instance;
    }
    ...
    public CSVImportLoginIDs(Window parent, ConfigServerManager _cfg) throws HeadlessException {
        super(parent, _cfg);
        cfg = _cfg;
