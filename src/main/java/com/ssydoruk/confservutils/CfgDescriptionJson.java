...
//                    enumProperties.add("values", context.serialize(e.));
					enumProperties
						.add("type", new JsonPrimitive(e.getEnumDescription().getCfgEnumClass().getSimpleName()));
					enumProperties
						.add("items", context
							.serialize(com.genesyslab.platform.commons.GEnum
								.values(e.getEnumDescription().getCfgEnumClass())));
		...
		@Override
		public CfgDescription deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
