...
//        }
		...
		// }
		kvpEditor.setData(new Object[] { "Section", "Key", "Value", "Action" }, values, 3);
		kvpEditor.doShow();
	...
	boolean checkParameters() {
		if (rbAddSection.isSelected()) {
			...
			if (StringUtils.isBlank(Utils.swing.Swing.checkBoxSelection(tfReplaceWith))) {
				JOptionPane
					.showMessageDialog(theForm, "\"Replace with \" string cannot be blank", "Cannot proceed", JOptionPane.ERROR_MESSAGE);
				return false;
			}
		}
		return true;
