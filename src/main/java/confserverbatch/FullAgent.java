...
public class FullAgent {
    ...
    HashMap<SwitchLookup, String> loginIDs = new HashMap();
    String pl = null;
...
//            }
    ...
    void createAll() throws ConfigException, CloneNotSupportedException {
        ...
        for (Map.Entry<SwitchLookup, String> entry : loginIDs.entrySet()) {
    ...
    void addLoginID(SwitchLookup switche, String string) {
...
//</editor-fold>
    ...
    private CfgAgentLogin createAgentLogin(SwitchLookup key, String value) throws ConfigException {
        try {
